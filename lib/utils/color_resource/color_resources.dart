...
class ColorResources {
  ...
  static Color get grey3 => const Color(0xFFDFDBDB);
  static Color get grey4 => HexColor('#8a8d91');
  static Color get grey5 => HexColor('#f7f7f7');
  /////////////////////////////////////

  static Color get appGreyColor => const Color(0xFF777777);
  static Color get appGreyColor2 => const Color(0xFFCCCCCC);
  static Color get appGreyColor3 => const Color(0xFFEBEBEB);
  static Color get appGreyColor4 => const Color(0xFFF0F0F0);
