        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () {
                themeVm.setTheme(themeVm.isDark==null?false:themeVm.isDark!);
              },
            ...
            ListTile(
              ...
              onTap: () {},
              trailing:
              SvgPicture.asset(IconResources.whatsapp),
            ...
            ListTile(
              ...
              onTap: () async {},
              trailing:
              SvgPicture.asset(IconResources.setting2),
            ...
            ListTile(
              horizontalTitleGap: 20.w,
              onTap: () async {},
              trailing: Icon(Icons.privacy_tip_outlined, size: 22.sp, color: Colors.white),
            ...
            ListTile(
              horizontalTitleGap: 20.w,
              onTap: () {},
              trailing: Icon(Icons.verified_outlined, size: 22.sp, color: Colors.white),
              // const Icon(Icons.star_border, size: 20.0, color: Colors.white),
              title: Text(
                'إصدار 1.0.0',
                textDirection: TextDirection.rtl,
