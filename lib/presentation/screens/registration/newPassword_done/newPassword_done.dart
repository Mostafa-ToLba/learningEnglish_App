...
class _NewPasswordDoneScreenState extends State<NewPasswordDoneScreen> with TickerProviderStateMixin{
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    width: 120.h, // Set the width and height to your desired size
                    height: 120.w,
                    decoration: BoxDecoration(
                      shape: BoxShape.circle,
                  ...
                  Text('تم اعادة تعيين كلمة السر',style: TextStyle(fontSize: 20.sp,fontFamily: AppConstants.arabicFont1,fontWeight: FontWeight.bold),),
                  SizedBox(height: 8.h,),
                  Center(child: Text('تم اعادة تعيين كلمة السر بنجاح',style: TextStyle(fontSize: 15.sp,fontFamily: AppConstants.arabicFont1,color: ColorResources.appGreyColor),)),
